...
if __name__ == '__main__':
    ...
    from imageSynthesize.imageFunctions import load_image, image_preprocessor, convert_to_image
    ...
    content_img = image_preprocessor(content_img_img, content_n_cols, content_n_rows)[0]#.transpose((2,1,0))
    style_img = load_image(style_image_path)
    style_n_channels, style_n_rows, style_n_cols = content_img_img.shape[::-1]
    style_img =  image_preprocessor(
    ...
    outimg = convert_to_image(result, contrast_percent=0)
